...
#### HL7 Europe Implementation Guides
- Replaced `ci.build` versions with frozen versions for:
    - HL7 Europe Hospital Discharge Report FHIR IG (**0.1.0-ballot**)
    - HL7 EU Medication Prescription and Dispense FHIR IG (**v0.1.0-ballot**)
    - HL7 EU Imaging Report FHIR IG (**v0.1.0-snapshot1**)

#### New Additions
- Added **IHE Manifest-based Access to DICOM Objects (MADO) v0.6**

#### Other Updates
- Updated **smart-health-cards-and-links** from **1.0.0-ballot** to **1.0.0**