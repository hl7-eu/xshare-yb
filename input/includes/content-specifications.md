...
|------|-------------|-------------|
| <img src="prescription.png" alt="Medicine Prescription and Dispense icon" style="width:30px; vertical-align:middle;"> | [Medicine Prescription and Dispense](https://x-bundles.ehr-exchange-format.eu/mpd-content/content.html) | [HL7 EU Medication Prescription and Dispense FHIR IG v1.0.0](https://hl7.eu/fhir/mpd/)
|------|-------------|-------------|
...
|------|-------------|-------------|
| <img src="care-plan.svg" alt="CarePlan icon" style="width:30px; vertical-align:middle;"> | CarePlan | [xShare Project CarePlan FHIR IG (0.1.0)](https://hl7.eu/fhir/ig/xshare-careplan)
|------|-------------|-------------|
